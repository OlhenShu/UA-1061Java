...
public class Collection {
    ...
    public Integer getMaxNumberIndex() {
        Integer index = null;
        Integer max = null;
        for (int i = 0; i < this.count; i++) {
    ...
    public Integer getMinNumberIndex() {
        Integer index = null;
        Integer min = null;
        for (int i = 0; i < this.count; i++) {
    ...
    public void swapElementsIndex(int first, int second) {
    ...
    public void inputNumberBeforeNegative() {
        Random random = new Random();
    ...
    public void inputZeroBetweenElements() {
    ...
    public List<Integer> getFirstElement(int countTo) {
        List<Integer> list = new ArrayList<>();
    ...
    public List<Integer> getLastElement(int countFrom) {
        List<Integer> list = new ArrayList<>();
    ...
    public void removeElementAfterMinimum() {
        int minIndex = this.getMinNumberIndex();
